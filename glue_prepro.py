...
def main(args):
    ...
    davidson_train_path = os.path.join(root, 'davidson/train.tsv')
    davidson_dev_path = os.path.join(root, 'davidson/dev.tsv')
    davidson_test_path = os.path.join(root, 'davidson/test.tsv')

    hateval_train_path = os.path.join(root, 'hateval/train.tsv')
    hateval_dev_path = os.path.join(root, 'hateval/dev.tsv')
    hateval_test_path = os.path.join(root, 'hateval/test.tsv')
    
    waseem_train_path = os.path.join(root, 'waseem/train.tsv')
    waseem_dev_path = os.path.join(root, 'waseem/dev.tsv')
    waseem_test_path = os.path.join(root, 'waseem/test.tsv')

    founta_train_path = os.path.join(root, 'founta/train.tsv')
    founta_dev_path = os.path.join(root, 'founta/dev.tsv')
    founta_test_path = os.path.join(root, 'founta/test.tsv')
    ...
    hateval_train_data = load_hateval(hateval_train_path)
    hateval_dev_data = load_hateval(hateval_dev_path)
    hateval_test_data = load_hateval(hateval_test_path)
