...
def data_config(parser):
    ...
    #parser.add_argument("--init_checkpoint", default="prajjwal1/bert-tiny", type=str) 
    #self.bert = BertModel.from_pretrained("prajjwal1/bert-tiny") dont use this one
    ...
    parser.add_argument('--train_datasets', default='davidson,hateval,waseem,founta')
    parser.add_argument('--test_datasets', default='davidson,hateval,waseem,founta')
